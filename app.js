...
Write a function called multiply() that takes in two numbers as arguments and returns an array where the first element is the
 product of those numbers, and the second element is a string that EXACTLY follows this example and uses the values that were
...
/* Problem 4
  ...
  function sumArray(testArray){ //eslint-disable-line
    ...
    var result = sum(x,testArray[2])[0];
    var string3 = testArray + ' was passed in as an array of numbers, and ' + result + ' is their sum.'
    console.log(string3);
    return [result, string3];
...
function multiplyArray(testArray){ //eslint-disable-line
  ...
  var y = multiply(testArray[0],testArray[1])[0];
  var result = multiply(y,testArray[2])[0];
